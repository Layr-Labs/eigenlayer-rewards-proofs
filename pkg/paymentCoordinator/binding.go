...
func (_ContractIPaymentCoordinator *ContractIPaymentCoordinatorCaller) CurrPaymentCalculationEndTimestamp(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
...
//
// Solidity: function currPaymentCalculationEndTimestamp() view returns(uint32)
func (_ContractIPaymentCoordinator *ContractIPaymentCoordinatorSession) CurrPaymentCalculationEndTimestamp() (uint32, error) {
...
//
// Solidity: function currPaymentCalculationEndTimestamp() view returns(uint32)
func (_ContractIPaymentCoordinator *ContractIPaymentCoordinatorCallerSession) CurrPaymentCalculationEndTimestamp() (uint32, error) {
	return _ContractIPaymentCoordinator.Contract.CurrPaymentCalculationEndTimestamp(&_ContractIPaymentCoordinator.CallOpts)
}
